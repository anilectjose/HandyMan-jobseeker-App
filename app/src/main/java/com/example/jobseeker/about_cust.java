...
public class about_cust extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_about_cust);
        ...
        BaseURL = getResources().getString(R.string.Base_URL)+"Completed.php";
        ...
        btn_co=findViewById(R.id.co_order);
        ...
        btn_co.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    new CompletedTask().execute();

            }
        });

    }
    private class CompletedTask extends AsyncTask<String,String, JSONObject>
    {
