...
public class view_all_works extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_all_works);

        ActionBar newbar=getSupportActionBar();
        assert newbar != null;
        newbar.setTitle("Services");

        shp = getSharedPreferences("login_data", MODE_PRIVATE);
        str_login_id = shp.getString("login_id", "");

        BaseUrl=getResources().getString(R.string.Base_URL);
        RegUrl=BaseUrl+"Services.php";//of api

        lv=(ListView)findViewById(R.id.work_list);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent newIn =new Intent(view_all_works.this,job_described.class);
    ...
    class list_leave extends AsyncTask<String,String, JSONObject> {
        ...
        public void onPostExecute(JSONObject jsonObject) {
            ...
            adapter=new service_all_adapter(view_all_works.this,list);
